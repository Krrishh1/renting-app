import uploadOnCloudinary from './controllers/config/cloudinary.js';
...
export const deleteListing = async (req,res) => {
    ...
    // 2. Try updating the host user (only if user exists)
    const user = await User.findById(listing.host);
    if (user) {
